...
$query = "SELECT * FROM $tablename WHERE name != '' AND restricted <='$level' ORDER by listNum";
...
while($Row = mysql_fetch_array($Result)){
		...
		$query1 = "SELECT * FROM $tablename WHERE linkTo ='$Row[name]'AND restricted <='$level' ORDER by listNum";
